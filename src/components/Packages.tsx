...
const tiers = [
  {
    ...
    name: "Keza Core",
    subtitle: "Basic Help",
    tagline: "For individuals who need reliable on-ground assistance.",
    limit: "Up to 5 tasks/month",
    updates: "Basic written updates",
    speed: "Standard",
    featured: false,
    features: [
      "General errands & task execution",
  ...
  },
  {
    id: "select",
    name: "Keza Select",
    subtitle: "Full Convenience",
    tagline: "For busy professionals and business owners who demand reliability.",
    limit: "10–15 tasks/month",
    updates: "Live updates with photos, videos & receipts",
    speed: "Priority handling",
    featured: false,
    features: [
      "Everything in Core",
      "Live photo/video/receipt updates",
      "Professional & business task management",
      "Property & supplier follow-ups",
      "Priority scheduling",
    ],
  },
  {
    ...
    tagline: "For diaspora clients, executives and property owners who require complete peace of mind.",
    ...
    features: [
      ...
      "Property checks & asset verification",
      "On-ground inspections",
      "Confidential errand handling",
      "VIP & emergency task handling",
...
const signature = {
  ...
  tagline:
    "Monthly check-ins, family care, and priority handling — structured for those who need Keza on permanent standby.",
  features: [
